...
from seq2seq.data.twitter import data

metadata, idx_q, idx_a = data.load_data(PATH='seq2seq/data/twitter/')                   # Twitter
(trainX, trainY), (testX, testY), (validX, validY) = data.split_dataset(idx_q, idx_a)

tf.reset_default_graph()
# metadata = np.load('metadata.npy').tolist()
# idx_q = np.load('idx_q.npy').tolist()
# idx_a = np.load('idx_a.npy').tolist()
# trainX = np.load('TrainX.npy').tolist()
# trainY = np.load('TrainY.npy').tolist()
# testX = np.load('TestX.npy').tolist()
# testY = np.load('TestY.npy').tolist()
# validX = np.load('ValidX.npy').tolist()
# validY = np.load('ValidY.npy').tolist()
